...
const DATA_SOURCES: DataSource[] = [
  ...
  },
  {
    id: 'gdelt',
    name: 'GDELT',
    fullName: 'GDELT Project - Global Database of Events, Language, and Tone',
    url: 'https://www.gdeltproject.org',
    description: 'Global news event and knowledge graph data used here for Russia-related threat events, coercive rhetoric quotations, media volume, and tone indicators.',
    dateRange: '2012 - Present',
    fallbackRecords: '728,000+ GDELT event and quotation records',
    spatialResolution: 'Country/entity-level event and media aggregates',
    updateFrequency: 'Near real-time source data; dashboard exports weekly/monthly aggregates',
    strengths: [
      'Large-scale global media monitoring',
      'CAMEO event coding with Goldstein scores',
      'Global Knowledge Graph quotation and theme signals',
      'Useful for comparative media volume and tone analysis',
    ],
    limitations: [
      'Machine-coded events and entities require interpretation',
      'Media attention is not the same as ground-truth event incidence',
      'Country/entity attribution can be noisy in automated pipelines',
    ],
    tables: [
