      ...
      <div className="chart-card">
        ...
        <ResponsiveContainer width="100%" height={350}>
          <LineChart data={monthlyChart} margin={{ top: 10, right: 20, bottom: 30, left: 20 }}>
            ...
            <Legend />
            <Line type="monotone" dataKey="violence" name="Violence" stroke="#ef4444" dot={false} strokeWidth={2} />
            <Line type="monotone" dataKey="civilian" name="Civilian Targeting" stroke="#f97316" dot={false} strokeWidth={2} />
            <Line type="monotone" dataKey="demonstrations" name="Demonstrations" stroke="#3b82f6" dot={false} strokeWidth={1.5} />
          </LineChart>
        </ResponsiveContainer>
      </div>
      ...
      <div className="chart-card">
        ...
        <ResponsiveContainer width="100%" height={450}>
          <BarChart data={topRegions} layout="vertical" margin={{ left: 150, right: 40 }}>
            ...
            <Legend />
            <Bar dataKey="violence_events" name="Violence Events" fill="#ef4444" />
            <Bar dataKey="civilian_events" name="Civilian Events" fill="#f97316" />
            <Bar dataKey="demonstration_events" name="Demonstrations" fill="#3b82f6" />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
